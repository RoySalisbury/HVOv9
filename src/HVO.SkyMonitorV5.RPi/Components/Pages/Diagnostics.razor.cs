...
public sealed partial class Diagnostics : ComponentBase, IAsyncDisposable
{
    ...
    private DataStoreInstanceMetrics? ImageArchiveStoreMetrics => DataStoreMetrics?.ImageArchiveStore;
    ...
    private string ImageArchiveDatabaseSizeDisplay => FormatBytes(ImageArchiveStoreMetrics?.FileBytes);
    ...
    private IReadOnlyList<DataStoreTableMetric> ImageArchiveTables => ImageArchiveStoreMetrics?.Tables ?? Array.Empty<DataStoreTableMetric>();
    ...
    private DataStoreBootstrapStatusMetrics? ImageArchiveBootstrap => ImageArchiveStoreMetrics?.Bootstrap;
