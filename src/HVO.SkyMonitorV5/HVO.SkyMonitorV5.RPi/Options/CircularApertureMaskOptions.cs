...
/// <summary>
/// Configuration values for the circular aperture mask overlay.
/// </summary>
public sealed class CircularApertureMaskOptions
{
    public const string SectionName = "CameraPipeline:CircularApertureMask";
