...
public partial class RoofControl : ComponentBase, IDisposable
{
    ...
    // Deprecated legacy code-behind kept minimal to avoid references in build. No logic is executed.
    public partial class RoofControl : Microsoft.AspNetCore.Components.ComponentBase
    {
    }
