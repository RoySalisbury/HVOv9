# SkyMonitor v5 Legacy AppSettings Snapshot

_Last updated: 2025-10-12_

This archive preserves the pre-datastore `appsettings.json` configuration that originally supplied observatory metadata, catalog references, and pipeline defaults from JSON. It exists for historical reference only now that Phase 4 migrates these values into the SQLite-backed configuration store.

```json
{
  "ConnectionStrings": {
    "HygDatabase": "Data Source=Data/hyg_v42.sqlite",
    "ConstellationDatabase": "Data Source=Data/ConstellationLines.sqlite"
  },
  "Logging": {
    "LogLevel": {
      "Default": "Information",
      ...
      "HVO.SkyMonitorV5.RPi.Data.SkyMonitorRepository": "Warning",
      "HVO.SkyMonitorV5.RPi.Pipeline.Filters.CelestialAnnotationsFilter": "Warning",
      "HVO.SkyMonitorV5.RPi.HostedServices.AllSkyCaptureService": "Debug",
      "HVO.SkyMonitorV5.RPi.Pipeline.FrameFilterPipeline": "Debug",
      "HVO.SkyMonitorV5.RPi.Pipeline.RollingFrameStacker": "Trace"
    }
  },
  "AllowedHosts": "*",
  "ObservatoryLocation": {
